      ...
      <div className="iconWrapper">
          ...
          <div className="icon">
            <a href='https://github.com/Sammaiah-Guguloth/' target='_blank'>
              <svg viewBox="0 0 24 24" width={30} height={30} xmlns="http://www.w3.org/2000/svg" fill="currentColor">
        ...
        <div className="iconWrapper">
          <a href="https://www.linkedin.com/in/guguloth-sammaiah" target='_blank'>
...
const StyledWrapper = styled.div`
  ...
  .instagram { background: linear-gradient(30deg, #0000ff, #f56040); }
  .linkedin { background: #0274b3; }
  .whatsapp { background: #25d366; }
  .youtube { background: #ff0000; }
  .github { background: #000000; }
