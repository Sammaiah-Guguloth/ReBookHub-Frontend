    ...
    <div className='flex flex-col min-h-screen'>
      ...
      <div className='flex-grow font-sans'>
        ...
        <div className='w-full max-w-screen-xl mx-auto flex flex-col justify-center items-center mt-10 lg:mt-14'>
          ...
          <div
            ref={bannerRef}
            className={`w-full mb-4 relative flex justify-center ${isInView ? "animate-slideUp" : ""}`}
          >
            <img
              className='w-[85vw] h-[37vw] object-cover rounded-md shadow-xl'
          ...
          {/* New Arrivals */}
          <div className={`w-full max-h-max ml-5 mt-5 ${isNewArrivalInView ? "animate-slideUp" : ""} `} ref={newArrivalsRef}>
          ...
          {/* Trending Genres */}
          {
            homeData?.trendingGenres.map((genre, index) => (
              genre.books.length > 0 && (
                <div className='w-full max-h-max ml-5 mt-5' key={index}>
                  <h2 className='text-2xl font-semibold mb-2'>{genre?.genre}</h2>
