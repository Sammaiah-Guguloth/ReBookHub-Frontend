...
import {setLoading , registrationSuccess , clearSignupState} from '../redux/slices/signupSlice'
    ...
    return (
        <>
            ...
            <div className="bg-white p-8 rounded-lg shadow-xl w-[90%] max-w-[400px] transition-transform">
                <h2 className="text-2xl font-heading mb-6 text-center">Verify Your Email</h2>
                
                <p className="text-center mb-4 text-gray-700">Enter the 6-digit code sent to your email.</p>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col items-center gap-4">
                    ...
                    <button 
                        ...
                        ${isOtpComplete ? 'bg-validated-green text-white hover:scale-105' : 'bg-gray-300 text-gray-600 cursor-not-allowed'}`}
