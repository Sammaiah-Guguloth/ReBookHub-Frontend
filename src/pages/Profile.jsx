...
const   Profile = () => {
  ...
  return (
    <div className="flex flex-col items-center w-full overflow-x-hidden">
      <h2 className="text-center text-2xl font-semibold mt-3 mb-3 animate-slideUp">
        My Profile
      </h2>
      <div className="w-full md:w-[90%] flex flex-col gap-6 items-center mx-auto px-4 animate-slideRight">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start border-2 p-4 rounded-md w-full gap-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                {editSection.address ? (
                  <input
                    ...
                    onChange={(e) => handleChange(e, "village", "address")}
                    className="border p-1 rounded"
                  />
                ) : (
                  <p className="font-semibold text-gray-800">
          ...
          <div className="flex gap-2 items-center border p-2 border-gray-300 rounded-md self-start">
            ...
            <button
              onClick={() =>
                setEditSection((prev) => ({ ...prev, address: !prev.address }))
              }
            >
        ...
        {isChanged && (
          <div
            className={`w-full md:w-[65%] text-center bg-gray-700 text-white py-2 px-4 rounded-md  ${
              loading ? "cursor-progress" : "cursor-pointer"
            } hover:scale-105 transition-transform mb-8`}
            onClick={handleSave}
          >
