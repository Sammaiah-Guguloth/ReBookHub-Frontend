...
import {setLoading , storeUserData , otpSent  } from "../redux/slices/signupSlice"
  ...
  return ( 
    <>
          ...
          <div className='w-screen max-w-site min-h-screen mb-5 overflow-hidden '>
            {/* Welcome message */}
            <h2 className='mt-5 text-center font-heading text-3xl font-[500] animate-slideUp '>Welcome to ReBook Hub</h2>
              ...
              <form onSubmit={handleSubmit(submitHandler)} className='flex self-start flex-col gap-3 w-full lg:w-[50%] animate-slideLeft'>
                  ...
                  <div className='flex flex-col gap-1 w-full'> 
                    ...
                    <input 
                      {...register("street", { 
                        ...
                        maxLength: { value: 50, message: "Street name is too long" }
                      })}
                      className='border-2 rounded-md py-2 px-2 outline-none font-sans text-gray-700'
                      type='text' id='street' name='street' placeholder="Street" 
                    />
                  </div>
                  <div className='flex flex-col gap-1 w-full'>
                    ...
                    <input 
                      {...register("village", { 
                        ...
                        maxLength: { value: 50, message: "Village name is too long" }
                      })}
                      className='border-2 rounded-md py-2 px-2 outline-none font-sans text-gray-700'
                ...
                <div className='flex flex-col md:flex-row gap-3'>
                  <div className='flex flex-col gap-1 w-full'> 
                    ...
                    <input 
                      ...
                      className='border-2 rounded-md py-2 px-2 outline-none font-sans text-gray-700'
                      type='text' id='city' name='city' placeholder="City or Town" 
                    />
                  </div>
                  <div className='flex flex-col gap-1 w-full'>
                ...
                <div className='flex flex-col gap-1 w-full'>
                    ...
                    <input 
                      ...
                      className='border-2 rounded-md py-2 px-2 outline-none font-sans text-gray-700'
                      type='text' id='state' name='state' placeholder='Telangana'/>
                  </div>
                ...
                <div>
                  ...
                  <Link to={"/login"} className='bg-secondary text-primary py-2 px-3 mt-5 w-full rounded-md hover:bg-primary-dark transition-all text-center'>
                    Login
                  </Link>
              </form>
